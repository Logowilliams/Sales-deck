...
#################
online_clean%>%
  dplyr::select(`WeekStart`, `Brand Desc`, `WM Week`, WeekEnd, `Store Nbr`, `Item Nbr`, UPC, `POS Qty`, `POS Sales`, `Total Customer Item Return`, `Curr Str On Hand Qty`, `Curr Instock %`, `Curr Str On Order Qty`, `Curr Str In Transit Qty`) -> onlineSql
...
#upcList$Retailer_ID <- as.character(upcList$Retailer_ID)
